...
class RequirePlugins {
    ...
    public function registerRequirePlugins()
    {
        ...
        $config = [
            ...
            'strings' => [
                'page_title' => __('Please install the necessary plugins', 'mooms'),
                'menu_title' => __('Plugins', 'mooms'),
                'installing' => __('Installing plugins: %s', 'mooms'),
                'updating' => __('Updating plugins: %s', 'mooms'),
                'oops' => __('An error occurred while communicating with the plugins API.', 'mooms'),
                'notice_can_install_required' => _n_noop('This theme set requires the following plugins to be installed: %1$s.', 'This theme set requires the following plugins to be installed: %1$s.', 'mooms'),
                'notice_can_install_recommended' => _n_noop('Bộ giao diện này đề xuất cài đặt và sử dụng các gói mở rộng sau: %1$s.', 'This set of themes recommends installing and using the following plugins: %1$s.', 'mooms'),
