...
abstract class AbstractTaxonomy
{
    ...
    public function getLabels()
    {
        return [
            ...
            'update_item'       => __('Update item', 'gaumap'),
            'add_new_item'      => __('Add new item', 'gaumap'),
            'new_item_name'     => __('New item name', 'gaumap'),
            'parent_item'       => __('Parent item', 'gaumap'),
            'parent_item_colon' => __('Mục cha:', 'gaumap'),
            'search_items'      => __('Search', 'gaumap'),
            'popular_items'     => __('Popular items', 'gaumap'),
