...
abstract class AbstractPostType
{
    ...
    protected function getLabels()
    {
        return [
            ...
            'add_new'               => __('Add new', 'gaumap'),
            'add_new_item'          => __('Add new post ' . $this->singularName, 'gaumap'),
            'edit_item'             => __('Edit post', 'gaumap'),
            'new_item'              => __('New post', 'gaumap'),
            'view_item'             => __('View post', 'gaumap'),
            'search_items'          => __('Search', 'gaumap'),
            'not_found'             => __('Not found', 'gaumap'),
            'not_found_in_trash'    => __('Not found in trash', 'gaumap'),
            'parent_item_colon'     => __('Parent:', 'gaumap'),
            'all_items'             => __('All posts', 'gaumap'),
            'archives'              => __('Archives', 'gaumap'),
            'insert_into_item'      => __('Insert posts', 'gaumap'),
            'uploaded_to_this_item' => __('Uploaded to this posts', 'gaumap'),
            'featured_image'        => __('Featured image', 'gaumap'),
            'set_featured_image'    => __('Set featured image', 'gaumap'),
            'remove_featured_image' => __('Remove featured image', 'gaumap'),
            'use_featured_image'    => __('Use featured image', 'gaumap'),
