...
abstract class AbstractPostType
{
    ...
    protected function getLabels()
    {
        return [
            ...
            'add_new_item'          => __('Add new item ' . $this->singularName, 'gaumap'),
            'edit_item'             => __('Edit item', 'gaumap'),
            'new_item'              => __('New item', 'gaumap'),
            'view_item'             => __('View item', 'gaumap'),
            ...
            'all_items'             => __('All items', 'gaumap'),
            'archives'              => __('Archives', 'gaumap'),
            'insert_into_item'      => __('Insert item', 'gaumap'),
            'uploaded_to_this_item' => __('Uploaded to this item', 'gaumap'),
